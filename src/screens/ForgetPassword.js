    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.contentcontainer}>
        <Text
          ...
          <Text style={{fontSize: 25,fontWeight:"bold",marginBottom:20,marginLeft: 100}}>
            Forgot Password?
          </Text>
        {errorflag ? <Text style={{ color: "red",marginLeft:25}}>{error}</Text> : <></>}
        <TextInput
          placeholder="Email"
          style={styles.input}
        ...
        <Text
            style={{ color: "#000000", marginBottom: 5, marginLeft: 160,marginTop: 20}}
            onPress={() => navigation.navigate("Login")}
          >
            Back to <Text style={{color: "purple",fontWeight:"bold"}}>Sign in</Text>
          </Text>
